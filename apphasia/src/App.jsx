...
import TerapeutaLogin from "./components/Therapist/TerapeutaLogin";
import DashboardTerapeuta from "./components/Therapist/DashboardTerapeuta";
import PacientesTerapeuta from "./components/Therapist/PacientesTerapeuta";
import EjerciciosTerapeuta from "./components/Therapist/EjerciciosTerapeuta";

import "./index.css";

function App() {
  const isLoggedIn = !!localStorage.getItem("terapeutaEmail");
    ...
    <Router>
      <Routes>
        ...
        <Route
          path="/dashboard"
          element={
            isLoggedIn ? <DashboardTerapeuta /> : <Navigate to="/" replace />
          }
        />
        ...
        <Route
          path="/pacientes"
          element={
            isLoggedIn ? <PacientesTerapeuta /> : <Navigate to="/" replace />
          }
        />
        ...
        <Route
          path="/ejercicios"
          element={
            isLoggedIn ? <EjerciciosTerapeuta /> : <Navigate to="/" replace />
          }
        />
